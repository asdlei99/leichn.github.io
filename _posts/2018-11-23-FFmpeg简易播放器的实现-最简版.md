本文首发地址：<https://www.cnblogs.com/leisure_chn/p/10040202.html>，转载请注明出处  
...
### 3.2 验证  
选用bigbuckbunny_480x272.h265测试文件，测试文件下载：[bigbuckbunny_480x272.h265](https://github.com/leichn/blog_resources/blob/master/video/bigbuckbunny_480x272.h265)  
运行测试命令：  
```shell  
