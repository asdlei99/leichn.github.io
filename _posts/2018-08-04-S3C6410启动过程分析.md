转载请注明出处：<https://leihl.github.io/2018/08/04/S3C6410%E5%90%AF%E5%8A%A8%E8%BF%87%E7%A8%8B%E5%88%86%E6%9E%90/>
...
![S3C6410存储系统结构图](https://leihl.github.io/_posts/img/s3c6410_booting/01_memory_system_structure.png "S3C6410存储系统结构图")
...
## 1.2 存储系统内存映射
S3C6410内存映射表如下所示：
![S3C6410内存映射表](https://leihl.github.io/_posts/img/s3c6410_booting/02_memory_map.png "S3C6410内存映射表")
...
# 2. 启动方式
S3C6410设备启动模式如下表所示：  
![S3C6410启动模式表](https://leihl.github.io/_posts/img/s3c6410_booting/03_booting_mode.png "S3C6410启动模式表")   
...
iROM启动方式如下图所示：
![S3C6410 iROM启动模式示意图](https://leihl.github.io/_posts/img/s3c6410_booting/04_iROM_booting_schematic.png "S3C6410 iROM启动模式示意图")  
...
![S3C6410 iROM启动模式流程图](https://leihl.github.io/_posts/img/s3c6410_booting/05_iROM_booting_flow.png "S3C6410 iROM启动模式流程图")  

与启动相关的存储器映射如下表所示：  
![S3C6410启动相关的存储器映射](https://leihl.github.io/_posts/img/s3c6410_booting/06_booting_regs_map.png "S3C6410启动相关的存储器映射")  
...
![S3C6410内存映射示意图](https://leihl.github.io/_posts/img/s3c6410_booting/07_memory_map2.png "S3C6410内存映射示意图")  
