...
前面几个实验分别实现了视频播放和音频播放，本实验将视频播放和音频播放结合在一起。本实验主要参考如下两篇文章：  
...
### 2.2 源码流程分析  
参考如下：  
![FFmpeg简易播放器-音频播放流程图](https://leihl.github.io/img/ffmpeg_player/02_player_avideo_flow.jpg "FFmpeg简易播放器-音视频播放流程图")  
...
<https://github.com/leihl/leihl.github.io/blob/master/source/ffmpeg/player_avideo/ffplayer.c>  
