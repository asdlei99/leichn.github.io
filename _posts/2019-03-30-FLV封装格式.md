...
| IF CodecID == 7<br>　CompositionTime | UI24   | PTS 与 DTS 的时间偏移值，单位 ms，记作 CTS。参考 "ISO 14496-12, 8.15.3" |
...
## 4. 总结
FLV 结构如下图所示：  
![FLV格式示意图](https://leichn.github.io/img/containers/flv.jpg "FLV格式示意图")  
...
[2] [FLV 存在B帧情况下的 DTS 和 PTS](https://www.jianshu.com/p/1cbe31baa711), <https://www.jianshu.com/p/1cbe31baa711>  
